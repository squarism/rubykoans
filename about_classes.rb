...
class AboutClasses < EdgeCase::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    fido.set_name("Fido")
    # this is different in 1.9.2-p290 vs 1.8.7
  ...
  def test_you_can_politely_ask_for_instance_variable_values
    ...
    # Learned: This is a lot different than Java which has default protection
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Learned: because the rails source code says so
    # /*
    # *  call-seq:
    # *     class.new(args, ...)    ->  obj
    # *
  ...
  def test_all_objects_support_to_s_and_inspect
    ...
    # assert_equal "123", array.flatten.to_s
