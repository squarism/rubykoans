...
It was the worst of times.
EOS
    # includes the \n characters but not the first one
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Learned: Tricky!  Did not know this!
    ...
    # Learned: http://ruby-doc.org/core/classes/String.html#M000768
    # += creates new string memory, shovel does not
    # test with object_id
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # Learned: yes. expected "a", got 97 in ruby 1.8.7
  end
