...
class AboutClassMethods < EdgeCase::Koan
  ...
  # Learned: this is a different notation than the usual class.self syntax
  ...
  # Learned: the first way is hard to read.  If there are pages and pages of methods then you
  # won't see that you're possibly in a class method.  However, the same problem exists for
  # private methods.
