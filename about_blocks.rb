...
class AboutBlocks < EdgeCase::Koan
  ...
  def test_blocks_can_be_assigned_to_variables_and_called_explicitly
    ...
    # Learned: did not know foo[bar] is the same as foo.call(bar), but seems unreadable.
  end
  ...
  # Learned: I don't grok this yet.  Need to do some code reading for when you'd use this
  # over standard method/arg passing.
