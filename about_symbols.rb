...
class AboutSymbols < EdgeCase::Koan
  ...
  def test_identical_symbols_are_a_single_internal_object
    ...
    # Learned: this is interesting.  Different than strings.
  ...
  # Learned: (or not learned) I don't know.  It's a global lookup so maybe to take a snapshot in 
  # case another process is running these tests?
  # Symbol.all_symbols.include?(:test_method_names_become_symbols) works so
  # I don't know.
  ...
  # Learned: collisions?  unpredictable behavior after that?
end
